"use client";
import { require_react_dom } from "./chunk-TTZBCBHQ.js";
import { require_react } from "./chunk-5PPXNRMD.js";
import { __toESM } from "./chunk-TXPGJST7.js";
...
var Vt = import_react2.default.createElement(
  "svg",
  {
...
var Kt = import_react2.default.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 20 20",
...
var Jt = import_react2.default.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 20 20",
...
var Ht = import_react2.default.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "12",
...
var mt = class {
  constructor() {
    ...
    this.create = (o) => {
      ...
      let { message: t, ...s } = o,
        g =
          ...
          ((P = o.id) == null ? void 0 : P.length) > 0
            ? o.id
            : ft++,
        l = this.toasts.find((h) => h.id === g),
        E = o.dismissible === void 0 ? true : o.dismissible;
      return (
        l
          ? (this.toasts = this.toasts.map((h) =>
              h.id === g
                ? (this.publish({ ...h, ...o, id: g, title: t }),
                  { ...h, ...o, id: g, dismissible: E, title: t })
                : h,
            ))
          : this.addToast({ title: t, ...s, dismissible: E, id: g }),
        g
      );
    };
    this.dismiss = (o) => (
      ...
      this.subscribers.forEach((t) => t({ id: o, dismiss: true })),
      o
    );
    ...
    this.promise = (o, t) => {
      ...
      let g = o instanceof Promise ? o : o(),
        l = s !== void 0,
        E,
        P = g
          .then(async (c) => {
          ...
          .catch(async (c) => {
            if (((E = ["reject", c]), t.error !== void 0)) {
              l = false;
              let y = typeof t.error == "function" ? await t.error(c) : t.error,
                k =
                  typeof t.description == "function"
                    ? await t.description(c)
                    : t.description;
        ...
        h = () =>
          new Promise((c, y) =>
            P.then(() => (E[0] === "reject" ? y(E[1]) : c(E[1]))).catch(y),
          );
...
var ce = (r) => {
  ...
  let {
    ...
    [B, q] = import_react.default.useState(false),
    [U, dt] = import_react.default.useState(false),
    [M, A] = import_react.default.useState(false),
    [Z, L] = import_react.default.useState(false),
    [Y, tt] = import_react.default.useState(false),
    [d, u] = import_react.default.useState(0),
    [b, w] = import_react.default.useState(0),
    D = import_react.default.useRef(t.duration || _ || Lt),
    f = import_react.default.useRef(null),
    H = import_react.default.useRef(null),
    et = h === 0,
    ot = h + 1 <= E,
    x = t.type,
    F = t.dismissible !== false,
    jt = t.className || "",
    Yt = t.descriptionClassName || "",
    at = import_react.default.useMemo(
      () => P.findIndex((n) => n.toastId === t.id) || 0,
      [P, t.id],
    ),
    Ft = import_react.default.useMemo(() => {
      var n;
      return (n = t.closeButton) != null ? n : O;
    }, [t.closeButton, O]),
    ue = import_react.default.useMemo(
      () => t.duration || _ || Lt,
      [t.duration, _],
    ),
    ct = import_react.default.useRef(0),
    $ = import_react.default.useRef(0),
    gt = import_react.default.useRef(0),
    nt = import_react.default.useRef(null),
    [ht, $t] = it.split("-"),
    bt = import_react.default.useMemo(
      () => P.reduce((n, m, p) => (p >= at ? n : n + m.height), 0),
      [P, at],
    ),
    yt = At(),
    Wt = t.invert || o,
    ut = x === "loading";
  ($.current = import_react.default.useMemo(() => at * lt + bt, [at, bt])),
    ...
    import_react.default.useEffect(() => {
      ...
      if (n) {
        ...
        return (
          w(m),
          l((p) => [{ toastId: t.id, height: m, position: t.position }, ...p]),
    ...
    import_react.default.useLayoutEffect(() => {
      ...
      (n.style.height = m),
        w(p),
        l((v) =>
          v.find((I) => I.toastId === t.id)
            ? v.map((I) => (I.toastId === t.id ? { ...I, height: p } : I))
            : [{ toastId: t.id, height: p, position: t.position }, ...v],
        );
    }, [B, t.title, t.description, l, t.id]);
  let z = import_react.default.useCallback(() => {
    dt(true),
      u($.current),
      l((n) => n.filter((m) => m.toastId !== t.id)),
      setTimeout(() => {
        k(t);
      }, le);
  }, [t, k, l, $]);
  ...
  function _t() {
    ...
    return N != null && N.loading
      ...
      : X
        ...
        : import_react.default.createElement(Dt, {
            className: R(
              a == null ? void 0 : a.loader,
  ...
  return import_react.default.createElement(
    "li",
    {
      ...
      className: R(
        ...
        (xt = t == null ? void 0 : t.classNames) == null ? void 0 : xt.toast,
        a == null ? void 0 : a.default,
        a == null ? void 0 : a[x],
        (vt = t == null ? void 0 : t.classNames) == null ? void 0 : vt[x],
      ),
      "data-sonner-toast": "",
      ...
      onPointerDown: (n) => {
        ut ||
          ...
          n.target.tagName !== "BUTTON" &&
            (A(true), (nt.current = { x: n.clientX, y: n.clientY })));
      },
      onPointerUp: () => {
        var v, W, I, It;
        if (Z || !F) return;
        ...
        let n = Number(
          ...
          m =
            ...
            ((W = f.current) == null ? void 0 : W.getTime()),
          p = Math.abs(n) / m;
        ...
        (It = H.current) == null ||
          It.style.setProperty("--swipe-amount", "0px"),
          A(false);
      },
      onPointerMove: (n) => {
        var W, I;
        if (!nt.current || !F) return;
        let m = n.clientY - nt.current.y,
          p =
            ((W = window.getSelection()) == null
              ? void 0
              : W.toString().length) > 0,
          v = ht === "top" ? Math.min(0, m) : Math.max(0, m);
        Math.abs(v) > 0 && tt(true),
          !p &&
            ((I = H.current) == null ||
              I.style.setProperty("--swipe-amount", `${v}px`));
      },
    },
    Ft && !t.jsx
      ? import_react.default.createElement(
          "button",
          {
            ...
            className: R(
              ...
              (Tt = t == null ? void 0 : t.classNames) == null
                ? void 0
                : Tt.closeButton,
            ),
          },
          (Rt = N == null ? void 0 : N.close) != null ? Rt : Ht,
        )
      : null,
    t.jsx || import_react.default.isValidElement(t.title)
      ? t.jsx
        ? t.jsx
      ...
      : import_react.default.createElement(
            ...
            ? import_react.default.createElement(
                "div",
                {
                  ...
                  className: R(
                    ...
                    (St = t == null ? void 0 : t.classNames) == null
                      ? void 0
                      : St.icon,
                  ),
                },
          ...
          import_react.default.createElement(
            "div",
            {
              ...
              className: R(
                ...
                (Et = t == null ? void 0 : t.classNames) == null
                  ? void 0
                  : Et.content,
              ),
            },
            import_react.default.createElement(
              "div",
              {
                ...
                className: R(
                  ...
                  (Nt = t == null ? void 0 : t.classNames) == null
                    ? void 0
                    : Nt.title,
                ),
              },
              ...
              ? import_react.default.createElement(
                  "div",
                  {
                    ...
                    className: R(
                      ...
                      (Pt = t == null ? void 0 : t.classNames) == null
                        ? void 0
                        : Pt.description,
                    ),
                  },
          ...
          import_react.default.isValidElement(t.cancel)
            ? t.cancel
            : t.cancel && V(t.cancel)
              ? import_react.default.createElement(
                  "button",
                  {
                    ...
                    onClick: (n) => {
                      ...
                      V(t.cancel) &&
                        F &&
                        ((p = (m = t.cancel).onClick) == null || p.call(m, n),
                        z());
                    },
                    className: R(
                      a == null ? void 0 : a.cancelButton,
                      (Ct = t == null ? void 0 : t.classNames) == null
                        ? void 0
                        : Ct.cancelButton,
                    ),
                  },
              ...
              : null,
          import_react.default.isValidElement(t.action)
            ? t.action
            : t.action && V(t.action)
              ? import_react.default.createElement(
                  "button",
                  {
                    ...
                    onClick: (n) => {
                      var m, p;
                      V(t.action) &&
                        ((p = (m = t.action).onClick) == null || p.call(m, n),
                        !n.defaultPrevented && z());
                    },
                    className: R(
...
var Be = (0, import_react.forwardRef)(function (o, t) {
  let {
      ...
      loadingIcon: rt,
      icons: _,
      containerAriaLabel: it = "Notifications",
      pauseWhenPageIsHidden: lt,
      cn: X = de,
    } = o,
    [C, a] = import_react.default.useState([]),
    N = import_react.default.useMemo(
      () =>
        Array.from(
          new Set(
            [g].concat(C.filter((d) => d.position).map((d) => d.position)),
          ),
        ),
      [C, g],
    ),
    [G, Q] = import_react.default.useState([]),
    [R, B] = import_react.default.useState(false),
    [q, U] = import_react.default.useState(false),
    [dt, M] = import_react.default.useState(
      y !== "system"
        ? y
    ...
    Y = import_react.default.useRef(false),
    tt = import_react.default.useCallback((d) => {
      a((u) => {
        var b;
        return (
          ((b = u.find((w) => w.id === d.id)) != null && b.delete) ||
            T.dismiss(d.id),
          u.filter(({ id: w }) => w !== d.id)
        );
      });
    }, []);
  return (
    import_react.default.useEffect(
      () =>
        T.subscribe((d) => {
          if (d.dismiss) {
            a((u) =>
              u.map((b) => (b.id === d.id ? { ...b, delete: true } : b)),
            );
            return;
          }
          setTimeout(() => {
    ...
    import_react.default.useEffect(() => {
      let d = (u) => {
        var w, D;
        l.every((f) => u[f] || u.code === f) &&
          (B(true), (w = A.current) == null || w.focus()),
          u.code === "Escape" &&
      ...
      N.map((d, u) => {
        ...
        return C.length
          ? import_react.default.createElement(
              "ol",
              {
                ...
                onFocus: (f) => {
                  (f.target instanceof HTMLElement &&
                    ...
                    Y.current ||
                    ((Y.current = true), (L.current = f.relatedTarget));
                },
                onMouseEnter: () => B(true),
                onMouseMove: () => B(true),
                onMouseLeave: () => {
              ...
              C.filter((f) => (!f.position && u === 0) || f.position === d).map(
                (f, H) => {
                  var et, ot;
                  return import_react.default.createElement(ce, {
                    ...
                    defaultRichColors: k,
                    duration:
                      (et = i == null ? void 0 : i.duration) != null ? et : j,
                    className: i == null ? void 0 : i.className,
                    descriptionClassName:
                      i == null ? void 0 : i.descriptionClassName,
                    invert: s,
                    visibleToasts: st,
                    closeButton:
                      (ot = i == null ? void 0 : i.closeButton) != null
                        ? ot
                        : P,
                    interacting: q,
                    position: d,
