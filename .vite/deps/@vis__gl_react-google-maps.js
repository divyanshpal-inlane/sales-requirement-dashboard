...
import { __commonJS, __toESM } from "./chunk-TXPGJST7.js";
...
// node_modules/.pnpm/@vis.gl+react-google-maps@1_f82ba4e3ee92179be87336f3a0033186/node_modules/@vis.gl/react-google-maps/dist/index.modern.mjs
...
var GoogleMapsApiLoader = class {
  ...
  static async load(params, onLoadingStatusChange) {
    ...
    if (
      ...
      (_window$google = _window$google.maps) != null &&
      _window$google.importLibrary
    ) {
  ...
  static initImportLibrary(params) {
    ...
    const loadApi = () => {
      ...
      apiPromise = new Promise((resolve, reject) => {
        ...
        scriptElement.nonce =
          ((_document$querySelect = document.querySelector("script[nonce]")) ==
          null
            ? void 0
            : _document$querySelect.nonce) || "";
...
function useMapInstances() {
  ...
  const removeMapInstance = (id = "default") => {
    setMapInstances((_ref) => {
      let remaining = _objectWithoutPropertiesLoose(
        _ref,
...
function useGoogleMapsApiLoader(props) {
  const { onLoad, onError, apiKey, version, libraries = [] } = props,
    otherApiParams = _objectWithoutPropertiesLoose(props, _excluded$3);
  const [status, setStatus] = (0, import_react.useState)(
    GoogleMapsApiLoader.loadingStatus,
  );
  const [loadedLibraries, addLoadedLibrary] = (0, import_react.useReducer)(
    (loadedLibraries2, action) => {
      return loadedLibraries2[action.name]
        ? loadedLibraries2
        : _extends({}, loadedLibraries2, {
            [action.name]: action.value,
          });
    },
    {},
  );
  const librariesString = (0, import_react.useMemo)(
    () => (libraries == null ? void 0 : libraries.join(",")),
    [libraries],
  );
  const serializedParams = (0, import_react.useMemo)(
    () =>
      JSON.stringify(
        _extends(
          {
  ...
  const importLibrary = (0, import_react.useCallback)(
    async (name) => {
      var _google;
      ...
      if (
        !(
          (_google = google) != null &&
          (_google = _google.maps) != null &&
          _google.importLibrary
        )
      ) {
        throw new Error(
    ...
    () => {
      (async () => {
        try {
          ...
          await GoogleMapsApiLoader.load(params, (status2) =>
            setStatus(status2),
          );
...
function createMapEvent(type, map, srcEvent) {
  ...
  if (cameraEventTypes.includes(type)) {
    ...
    mouseEvent.detail = {
      latLng:
        ((_srcEvent$latLng = srcEvent.latLng) == null
          ? void 0
          : _srcEvent$latLng.toJSON()) || null,
...
function useApiLoadingStatus() {
  var _useContext;
  return (
    ((_useContext = (0, import_react.useContext)(APIProviderContext)) == null
      ? void 0
      : _useContext.status) || APILoadingStatus.NOT_LOADED
  );
}
...
function useMapInstance(props, context) {
  ...
  for (const key of Object.keys(mapOptions))
    if (mapOptions[key] === void 0) delete mapOptions[key];
...
var Map = (props) => {
  ...
  const combinedStyle = (0, import_react.useMemo)(
    () =>
      _extends(
        {
          width: "100%",
...
var MarkerContent = ({ children, styles, className, anchorPoint }) => {
  const [xTranslation, yTranslation] =
    anchorPoint != null ? anchorPoint : AdvancedMarkerAnchorPoint["BOTTOM"];
...
function useAdvancedMarker(props) {
  ...
  const [contentContainer, setContentContainer] = (0, import_react.useState)(
    null,
  );
  const map = useMap();
  ...
  useDomEventListener(
    marker == null ? void 0 : marker.element,
    "mouseenter",
    onMouseEnter,
  );
  useDomEventListener(
...
var AdvancedMarker = (0, import_react.forwardRef)((props, ref) => {
  ...
  const advancedMarkerContextValue = (0, import_react.useMemo)(
    () =>
      marker
        ? {
            marker,
...
var InfoWindow = (props) => {
  ...
  (0, import_react.useEffect)(
    () => {
      ...
      return () => {
        ...
        (_contentContainerRef$ = contentContainerRef.current) == null ||
          _contentContainerRef$.remove();
        (_headerContainerRef$c = headerContainerRef.current) == null ||
          _headerContainerRef$c.remove();
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (anchor) {
      ...
      if (isAdvancedMarker(anchor) && anchor.content instanceof Element) {
        ...
        const wrapperBcr =
          wrapper == null ? void 0 : wrapper.getBoundingClientRect();
        if (wrapperBcr && wrapper != null && wrapper.isCustomMarker) {
          var _anchor$content$first;
          const anchorDomContent =
            (_anchor$content$first = anchor.content.firstElementChild) == null
              ? void 0
              : _anchor$content$first.firstElementChild;
          const contentBcr =
            anchorDomContent == null
              ? void 0
              : anchorDomContent.getBoundingClientRect();
          const anchorOffsetX =
            contentBcr.x -
            wrapperBcr.x +
  ...
  return import_react.default.createElement(
    ...
    null,
    contentContainerRef.current &&
      (0, import_react_dom.createPortal)(children, contentContainerRef.current),
    headerContainerRef.current !== null &&
      (0, import_react_dom.createPortal)(
        headerContent,
        headerContainerRef.current,
...
var MapControl = ({ children, position }) => {
  const controlContainer = (0, import_react.useMemo)(
...
function useMarker(props) {
  const [marker, setMarker] = (0, import_react.useState)(null);
  const map = useMap();
  const { onClick, onDrag, onDragStart, onDragEnd, onMouseOver, onMouseOut } =
      props,
...
var Pin = (props) => {
  ...
  const advancedMarker =
    (_useContext = (0, import_react.useContext)(AdvancedMarkerContext)) == null
      ? void 0
      : _useContext.marker;
  const glyphContainer = (0, import_react.useMemo)(
    () => document.createElement("div"),
    [],
  );
  (0, import_react.useEffect)(() => {
    ...
    const markerContent =
      (_advancedMarker$conte = advancedMarker.content) == null ||
      (_advancedMarker$conte = _advancedMarker$conte.firstChild) == null
        ? void 0
        : _advancedMarker$conte.firstChild;
