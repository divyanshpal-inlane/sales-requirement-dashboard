  ...
  useEffect(() => {
    ...
    const map = new window.google.maps.Map(
      document.getElementById("distance-map"),
      {
        ...
        center: {
          lat:
            (distanceInfo.instructorLocation.latitude +
              distanceInfo.learnerLocation.latitude) /
            2,
          lng:
            (distanceInfo.instructorLocation.longitude +
              distanceInfo.learnerLocation.longitude) /
            2,
        },
      },
    );
                ...
                <CardContent className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">
                      ...
                      {Math.floor(distanceInfo.duration / 60)}h{" "}
                      {distanceInfo.duration % 60}min
                    </span>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-2">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {distanceInfo.instructorLocation.address}
                    </p>
                  </div>
                  <div>
                    <strong className="text-green-600">Learner:</strong>
                    <p className="text-sm text-gray-600">
                      {distanceInfo.learnerLocation.address}
                    </p>
                  </div>
                </CardContent>
              </Card>
